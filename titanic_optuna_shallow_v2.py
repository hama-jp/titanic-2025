"""
Titanic Perished Prediction - Optuna Very Shallow Trees
元の16特徴量 + 非常に浅い木に絞った探索

戦略:
1. v2.6の特徴量セット（16個）を使用（元に戻す）
2. 非常に浅い木に絞って探索:
   - num_leaves: 8 ~ 12（より浅く）
   - max_depth: 3 ~ 5
3. 追加ハイパーパラメータ: min_child_samples, min_gain_to_split, bagging_freq
4. 閾値の最適化
5. 250 trials で探索
"""
...
def objective(trial, X, y, features, categorical_features, n_splits=5, seed=42):
    ...
    params = {
        ...
        'num_leaves': trial.suggest_int('num_leaves', 8, 12),  # 8-12に絞る
...
if __name__ == "__main__":
    print("=" * 60)
    print("Titanic - Optuna Very Shallow Trees")
    print("元の16特徴量 + num_leaves 8-12に絞った探索")
    print("=" * 60)
    print()
    ...
    print("探索範囲:")
    print("  - num_leaves: 8-12（非常に浅い木）")
    print("  - max_depth: 3-5")
    print("  - min_child_samples: 10-30")
    print("  - min_gain_to_split: 0.0-1.0")
    print("  - bagging_freq: 1-7")
    print("  - threshold: 0.4-0.6")
    ...
    submission_file = 'submission_optuna_shallow_v2.csv'
    ...
    print(f"非常に浅い木版: {study.best_value:.2%} OOF Accuracy")
    ...
    print("\n改良内容:")
    print("  ✅ 元の16特徴量に戻す")
    print("  ✅ num_leavesを8-12に絞る（非常に浅い木）")
    print("  ✅ 追加パラメータ（min_child_samples等）")
    print("  ✅ 閾値最適化")
