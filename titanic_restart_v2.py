"""
Titanic Perished Prediction - 戦略的アプローチ v2
train+testを最大限活用

改善点:
- TicketGroupSize: 既に実装済み ✓
- FamilyGroupSize: Surname+FamilySizeでtrain+testからグループサイズ計算
- CabinGroupSize: Cabinの共有状況をtrain+testで計算
- 生存率は使わない（リーク防止）、グループサイズのみ
"""
...
if __name__ == "__main__":
    print("=" * 60)
    print("Titanic Perished Prediction v2")
    print("train+testを最大限活用")
    print("=" * 60)
    print()
    ...
    print("NEW特徴量:")
    print("  - FamilyGroupSize: train+testでSurname+FamilySizeのグループサイズ")
    print("  - CabinGroupSize: train+testでCabin共有人数")
    print("  - HasFamilyMatch: 同じ家族が複数見つかったか")
    print()
    ...
    submission_file = 'submission_restart_v2.csv'
    ...
    print("\n" + "=" * 60)
    print("v1からの改善点:")
    print("  ✓ FamilyGroupSize追加（train+testで計算）")
    print("  ✓ CabinGroupSize追加（train+testで計算）")
    print("  ✓ HasFamilyMatch追加（家族マッチング）")
    print("=" * 60)
    print("完了！")
    print("=" * 60)
