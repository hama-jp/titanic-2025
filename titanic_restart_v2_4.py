...
if __name__ == "__main__":
    ...
    features = [
        ...
        'Sex', 'Pclass', 'Embarked', 'Title', 'Deck', 'AgeBin',
        # フラグ
        # 'IsAlone',  # v2.4: 削除（FamilySize==1と完全冗長）
        'IsChild', 'IsMother',
        'HasFamilyMatch'
    ]
    ...
    print("v2.4の変更:")
    print("  - v2.2からIsAlone を削除")
    print("  - 理由: IsAlone = (FamilySize == 1) と完全冗長")
    print("  - 特徴量数: 17個 → 16個")
    print()
    ...
    submission_file = 'submission_restart_v2_4.csv'
    ...
    print("=" * 60)
    print("✓ v2.2から変更:")
    print("  - IsAlone を削除（FamilySize==1と完全冗長）")
    print("  - 特徴量数: 17個 → 16個")
    print()
    print("検証ポイント:")
    print("  1. v2.2とのCVスコア比較（84.29% vs ?）")
    print("  2. IsAloneの情報はFamilySizeで十分か")
    print("=" * 60)
    print("完了！")
    print("=" * 60)
