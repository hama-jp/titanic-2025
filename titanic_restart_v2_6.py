...
if __name__ == "__main__":
    ...
    print("v2.6の変更:")
    print("  - v2.2からAge を削除")
    print("  - 理由: AgeBin, IsChild, IsMother, Titleと相関が高い")
    print("  - 特徴量数: 17個 → 16個")
    print()
    ...
    submission_file = 'submission_restart_v2_6.csv'
    ...
    print("=" * 60)
    print("✓ v2.2から変更:")
    print("  - Age を削除（AgeBin, IsChild, IsMother, Titleと相関）")
    print("  - 特徴量数: 17個 → 16個")
    print()
    print("検証ポイント:")
    print("  1. v2.2とのCVスコア比較（84.29% vs ?）")
    print("  2. Ageの連続値情報がAgeBin等で代替可能か")
    print("=" * 60)
    print("完了！")
    print("=" * 60)
