...
if __name__ == "__main__":
    ...
    features = [
        ...
        'CabinGroupSize',
        # カテゴリ
        'Sex', 'Pclass', 'Embarked', 'Title', 'Deck',
        # 'AgeBin',  # v2.5: 削除（Ageから導出、重要度0.647で最下位）
        # フラグ
    ...
    print("v2.5の変更:")
    print("  - v2.2からAgeBin を削除")
    print("  - 理由: Ageから導出されたカテゴリ変数、重要度0.647で最下位")
    print("  - 特徴量数: 17個 → 16個")
    print()
    ...
    submission_file = 'submission_restart_v2_5.csv'
    ...
    print("=" * 60)
    print("✓ v2.2から変更:")
    print("  - AgeBin を削除（Ageから導出、重要度0.647で最下位）")
    print("  - 特徴量数: 17個 → 16個")
    print()
    print("検証ポイント:")
    print("  1. v2.2とのCVスコア比較（84.29% vs ?）")
    print("  2. AgeBinのカテゴリ化情報が本当に不要か")
    print("=" * 60)
    print("完了！")
    print("=" * 60)
