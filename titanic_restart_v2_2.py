...
if __name__ == "__main__":
    ...
    print("v2からの変更:")
    print("  - SibSp, Parch を削除（重要度26, 25）")
    print("  - 理由: FamilySize = SibSp + Parch + 1 に含まれている")
    print("  - 特徴量数: 19個 → 17個")
    print()
    ...
    submission_file = 'submission_restart_v2_2.csv'
