...
if __name__ == "__main__":
    ...
    print("v2.3の変更:")
    print("  - v2.2からFare を削除")
    print("  - 理由: FarePerPerson (Fare/TicketGroupSize) で代表可能か検証")
    print("  - 特徴量数: 17個 → 16個")
    print()
    ...
    submission_file = 'submission_restart_v2_3.csv'
    ...
    print("=" * 60)
    print("✓ v2.2から変更:")
    print("  - Fare を削除（FarePerPersonで代表可能か検証）")
    print("  - 特徴量数: 17個 → 16個")
    print()
    print("検証ポイント:")
    print("  1. v2.2とのCVスコア比較（84.29% vs ?）")
    print("  2. Fareの絶対値情報が必要か、FarePerPersonだけで十分か")
    print("=" * 60)
    print("完了！")
    print("=" * 60)
